    ...
    while (1) {
        ...
        switch (input) {
            case 1:
                {
                    printf(
                        "enter data(integer) to be stored in the new node: ");
                    warn(&data);
                    insert_front(data);
                    printf("new node containing \'%d\' has been inserted at "
                           "the front of the "
                           "list.\n"
            ...
            case 2:
                {
                    ...
                    printf("new node containg \'%d\' has been inserted in the "
                           "list.\n"
                           "(current number of node(s) in the list = %d)\n",
                           data_new, list_size());
                    break;
            ...
            case 5:
                {
                    ...
                    int data_prev = 0;
                    printf("enter the data(integer) stored on the node to be "
                           "deleted: ");
                    warn(&data_prev);
                    free_node(data_prev);
                    break;
            ...
            case 7:
                {
                    ...
                    printf("enter the data(integer) of the node to search for "
                           "in the list: ");
                    warn(&data);
                    int index = 0;
